...
public class TaulerMemory {
	...
	// Delaraci� de constants	
	public static final int MIDA = 4;// n�mro de files i columnes de la matriu quadrada	
	...
	// Constructor
	/* Cal inicialitzar els atributs degudament  i a continuaci� cridar al m�tode omplirTauler()*/
	public TaulerMemory() {
	...
	/*
	 * Retorna una c�pia de la matriu tauler no retorna la matriu teuler
	 */
	...
	/*
	 * Cal emplenar el vector lletres amb els car�cters de l''A' a la 'Z' en total seran
	 * 26 lletres amb els codis enters del 65 al 90 per exemple el int 65 el podem
	 * convertir al car�cter 'A' fent char c = (char) 65;
	 * Aquest m�tode �s cridat pel constructor.
	 */
	...
	/*
	 *Col�locar el car�cter de l�argument a la matriu tauler en una casella triada aleat�riament
